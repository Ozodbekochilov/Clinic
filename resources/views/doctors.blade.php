...
<body>
    <div class="container">
        ...
        <button type="button" class="btn btn-info"><a href="http://clinic.loc/patient">Patient</a></button>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-danger" type="button"
                                onclick="delete_doctor({{ $item->id }})">Delete</button>
...
<script>
    function save_doctor() {
        ...
        var settings = {
            "url": "http://clinic.loc/save_doctor",
            "method": "POST",
            "timeout": 0,
            "processData": false,
        ...
        for (const i of data) {
            $('#tbody').append(`
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-danger" type="button"
                                onclick="delete_doctor(${i.id   })">Delete</button> 
                                <button type="button" class="btn btn-info"
    ...
    function delete_doctor(id) {
        var settings = {
            "url": "http://clinic.loc/delete_doctor/" + id,
            "method": "GET",
            "timeout": 0,
        };
    ...
    function save_edit(id) {
        ...
        var settings = {
            "url": "http://clinic.loc/save_edit_doctor/" + id,
            "method": "POST",
            "timeout": 0,
            "processData": false,
            "mimeType": "multipart/form-data",
